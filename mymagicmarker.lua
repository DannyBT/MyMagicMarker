...
local function CreateMarkTargetFrame (parent)
    ...
    -- Textbox
    f.frmtxt = CreateFrame ("Frame", nil, f, 'BackdropTemplate')
    ...
    -- Marks frame
    f.fm = CreateFrame ("Frame", nil, f, 'BackdropTemplate')
...
do
    ...
    -- The scroll bar
    f.scrl = CreateFrame ("Slider", nil, f, 'BackdropTemplate')
    local s = f.scrl
...
do
    local cur = CreateFrame ("Frame", 'frmMagicMarker_curMark', UIParent, 'BackdropTemplate')
